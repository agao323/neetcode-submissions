...
class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        TIME:
            ...
            1:06:21.72 - finished implementation after looking at solution
                - need to revisit this one for implementation practice
                - also only got the answer after some hints
