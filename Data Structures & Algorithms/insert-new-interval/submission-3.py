class Solution:
    def insert(self, intervals: List[List[int]], newInterval: List[int]) -> List[List[int]]:
        ...
        algorithm:
            TIME:
                1:01:59.74 - initial linear approach
                    really bad. implementation super poor. too many edge cases were
                    not accounted for and had to keep going back and fixing code, all
                    for the non-optimized linear solution
                1:16:02.37 - greedy
        ...
        three cases
            1. interval completely before newInterval
                interval[1] < newInterval[0]
            2. interval completely after newInterval
                interval[0] > newInterval[1]
                we can return early here, nothing after needs to be checked
            3. interval is overlapping
                interval[0] <= newInterval[0] or
