class Solution:
    def dailyTemperatures(self, temperatures: List[int]) -> List[int]:
        """
        TIME: 48:23.18
            - time isn't great, but felt good because did not look at hints or solutions
              and have never done this problem before, but was able to get through it
              and figure out the optimal (non-DP) solution
            - took too long to get through the implementation, that took most of the time
              and this should be relatively simple. need more practice
