...
class Solution:
    def minEatingSpeed(self, piles: List[int], h: int) -> int:
        """
        TIME: 53:12.98
            tough one. took ~35 minutes just to figure out the solution from looking at the
            topic (saw binary search) and recommend time & space complexity O(nlogm).
            time complexity gave me the biggest clue for the solution.
            even then - took me almost 20 minutes to implement, way too messy.
                note: left start should be 1 because that's the min possible speed, not 0.
                      starting at 0 was giving me divide by 0 errors
